...
const searchTvSeasonById = async (id: string | number, number: number, language: string = "en"): Promise<Season> => {
...
const searchTvShow = async (query: string, page: number, language: string = "en"): Promise<TMDBResponse<Serie>> => {
...
const searchTvShowById = async (id: string | number, language: string = "en"): Promise<Serie> => {
...
const popularTvShow = async (page: number, language: string = "en"): Promise<TMDBResponse<Serie>> => {
  const request = await axios.get<TMDBResponse<Serie>>(
